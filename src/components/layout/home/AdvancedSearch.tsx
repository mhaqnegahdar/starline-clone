const AdvancedSearch = () => {
  return (
    <section className="p-0 px-2 px-md-3 px-lg-5 m-0 py-5 w-100 d-flex justify-content-center align-items-center bg-dark-2">
      <form className=" search justify-content-center gap-4 gap-sm-2 gap-md-3 align-items-stretch d-flex flex-column flex-lg-row w-100 flex-grow-1 px-lg-5 ">
        ...
        <button
          className="p-0 m-0 btn btn-danger col-lg-2 col-12 rounded-0 py-1 fs-5 search__input"
          type="submit"
        >
          Button
        </button>{" "}
