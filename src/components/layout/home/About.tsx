const About = () => {
  return (
    <section className="about object-fit-cover position-relative row ">
      ...
      <div className="p-0 m-0  p-0 m-0 col-12 col-md-7 col-lg-5  px-3 px-md-5 d-flex flex-column justify-content-around z-3">
        <div className=" w-100 p-0 m-0  col-md-7 ">
          <h1 className="p-0 px-2 m-0 py-4">
            Welcom to<br></br>House Of Cars
          </h1>
          <div className="px-1 px-md-2 pb-1 m-0">
            <p className="lh-3 pb-3">
